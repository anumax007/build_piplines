<%@ Page language="c#" Inherits="edmsNET.Setup.setup2" CodeFile="setup2.aspx.cs" %>
		...
		<form method="post" runat="server">
			...
			<hr width="100%" size="1">
				...
				<b>Setting up Your Database and SMTP Connection</b>
					...
					edms.NET needs to connect to a database in order to function properly. Fill in 
					the following fields with the connection information for your database. Note: 
					you should already have completed the import of the edms.NET database schema as 
			...
			<div>
					<table cellspacing="1" cellpadding="3" width="90%" border="1">
						<tr>
							...
							<td style="WIDTH: 25%"><asp:textbox id="txtDatabase" runat="server" width="100%">edmsNET</asp:textbox></td>
							<td style="WIDTH: 2%">&nbsp;
								<asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" display="dynamic" ErrorMessage="You must enter database name"
									controltovalidate="txtDatabase">*</asp:requiredfieldvalidator></td>
							<td style="WIDTH: 53%"><em>The name of the database to be used.<br>
									&nbsp;No default value.&nbsp; <font size="+0">e.g. 'edmsNET'</font></em></td>
						</tr>
						<tr>
							...
							<td style="WIDTH: 2%">&nbsp;
								<asp:requiredfieldvalidator id="RequiredFieldValidator2" runat="server" display="dynamic" ErrorMessage="You must enter a data source or server"
									controltovalidate="txtDataSource">*</asp:requiredfieldvalidator></td>
							<td style="WIDTH: 53%">
							<em>The name of the data source or server&nbsp;to connect to.
									<br>
									No default value.&nbsp;<font size="+0">e.g. 'localhost'
									</font></em></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="WIDTH: 2%">&nbsp;
								<asp:rangevalidator id="RangeValidator1" runat="server" display="Dynamic" ErrorMessage="Only numbers between 0 and 10000 accepted"
									controltovalidate="txtTimeout" maximumvalue="10000" minimumvalue="0" type="Integer">*</asp:rangevalidator></td>
						...
						<asp:button id="bnDBConnect" runat="server" Text="Make Connections" ></asp:button>
					<hr width="100%" size="1" />
					
						<asp:HyperLink id="HyperLink1" runat="server" Font-Size="XX-Small" NavigateUrl="http://www.contentmgr.com">www.contentmgr.com</asp:HyperLink>
		</form>
