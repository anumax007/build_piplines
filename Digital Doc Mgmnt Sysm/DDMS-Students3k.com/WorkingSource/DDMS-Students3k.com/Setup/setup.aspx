<%@ Page language="c#" Inherits="edmsNET.Setup.setup" CodeFile="setup.aspx.cs" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <hr width="100%" size="1">
            <p><b>Welcome to the edms.NET Setup</b></p>
            <p>It has been detected that your system needs to be setup for edms.NET. This tool 
                ...
                use edms.NET Administration&nbsp;to build your own site.</p>
            ...
            <p>in the <code><strong>&lt;appsettings&gt;</strong></code> element of 
                edms.NET's&nbsp;Web.config file.
            </p>
            <p align="center">
                <asp:Button id="bnContinue" runat="server" Text="Continue" onclick="bnContinue_Click"></asp:Button></p>
            <hr width="100%" size="1">
            <p align="center">
