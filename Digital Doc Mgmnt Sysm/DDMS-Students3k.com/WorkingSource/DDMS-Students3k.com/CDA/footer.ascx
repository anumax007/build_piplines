<%@ Control Language="c#" Inherits="edmsNET.CDA.Footer" CodeFile="Footer.ascx.cs" %>
<center>
...
<center>
    &nbsp;
    <asp:HyperLink id="HyperLink1" runat="server" ForeColor="#0A246A" NavigateUrl="mailto:srgfraser@contentmgr.com">
