<%@ Control Language="c#" Inherits="edmsNET.CDA.Protected.ZoneCard" CodeFile="ZoneCard.ascx.cs" %>
...
<asp:DropDownList id="ddlZones" runat="server" AutoPostBack="True" Visible="False" onselectedindexchanged="ddlZones_SelectedIndexChanged"></asp:DropDownList></asp:Panel></TD>
            <TD width="5%"></TD>
            <TD width="2%">
