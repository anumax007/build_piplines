<%@ Reference Page="~/cda/storypg.aspx" %>
...
<%@ Page language="c#" Inherits="edmsNET.CDA.Protected.StoryPg" CodeFile="StoryPg.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
