...
namespace edmsNET.Administration.Util
{
	public partial class AdmShutdown : edmsNET.Common.AuthorizedPage
	{
        ...
        protected void bnStartStop_Click(object sender, System.EventArgs e)
        {
            bool isready = false; 
