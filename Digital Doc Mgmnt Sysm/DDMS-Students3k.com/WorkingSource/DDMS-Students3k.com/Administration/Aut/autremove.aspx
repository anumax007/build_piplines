<%@ Page language="c#" Inherits="edmsNET.Administration.AUT.AutRemove" CodeFile="AutRemove.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <P><asp:button id="bnRemove" runat="server" Text="Remove Content" onclick="bnRemove_Click"></asp:button>&nbsp;
