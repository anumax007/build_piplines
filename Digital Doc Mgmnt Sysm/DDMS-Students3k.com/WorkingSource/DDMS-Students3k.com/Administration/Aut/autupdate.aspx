<%@ Page language="c#" Inherits="edmsNET.Administration.AUT.AutUpdate" CodeFile="AutUpdate.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <asp:Button id="bnInsert" runat="server" Text="Update with new version" onclick="bnInsert_Click"></asp:Button>
            &nbsp;
            <asp:Button id="bnUpdate" runat="server" Text="Update this version" onclick="bnUpdate_Click"></asp:Button>
            &nbsp;
            <asp:Button id="bnRestore" runat="server" Text="Restore" onclick="bnRestore_Click"></asp:Button>
            &nbsp;
            <asp:Button id="bnRemove" runat="server" Text="Remove" onclick="bnRemove_Click"></asp:Button>
        </form>
    </body>
</HTML>
