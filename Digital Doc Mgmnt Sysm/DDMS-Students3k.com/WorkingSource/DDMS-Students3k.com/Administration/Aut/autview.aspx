<%@ Page language="c#" Inherits="edmsNET.Administration.AUT.AutView" CodeFile="AutView.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <asp:Button id="bnReturn" runat="server" Text="Back" onclick="bnReturn_Click"></asp:Button>
            &nbsp;
            ...
            &nbsp;
            <asp:button id="bnUpdate" runat="server" Text="Update" onclick="bnUpdate_Click"></asp:button>
            &nbsp;
