<%@ Page language="c#" Inherits="edmsNET.Administration.AdmAcnt.AdmAcntUpdate" CodeFile="AdmAcntUpdate.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <P>&nbsp;&nbsp; <INPUT onclick="window.history.back()" type="button" value="Cancel">&nbsp;
                ...
                <asp:Button id="bnRemove" runat="server" Text="Remove" onclick="bnRemove_Click"></asp:Button></P>
        </form>
    </body>
</HTML>
