<%@ Page language="c#" Inherits="edmsNET.Administration.AdmAcnt.admAcntRemove" CodeFile="admAcntRemove.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <P>
                <asp:button id="bnRemove" runat="server" Text="Remove Account" onclick="bnRemove_Click"></asp:button>&nbsp;
