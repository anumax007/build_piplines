<%@ Page language="c#" Inherits="edmsNET.Administration.Approve.AppApprove" CodeFile="AppApprove.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <P>
                <asp:button id="bnApprove" runat="server" Text="Approve Content" onclick="bnApprove_Click"></asp:button>
