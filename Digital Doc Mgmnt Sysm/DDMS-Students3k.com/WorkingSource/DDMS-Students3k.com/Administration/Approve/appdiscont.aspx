<%@ Page language="c#" Inherits="edmsNET.Administration.Approve.AppDiscont" CodeFile="AppDiscont.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <P>
                <asp:button id="bnReturn" runat="server" Text="Discontinue Content" onclick="bnReturn_Click"></asp:button>
