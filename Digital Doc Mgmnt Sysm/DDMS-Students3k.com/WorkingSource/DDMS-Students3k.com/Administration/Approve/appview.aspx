<%@ Page language="c#" Inherits="edmsNET.Administration.Approve.AppView" CodeFile="AppView.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <asp:Button id="bnBack" runat="server" Text="Back" onclick="bnBack_Click"></asp:Button>
            &nbsp;
            ...
            &nbsp;
            <asp:button id="bnApprove" runat="server" Text="Approve" onclick="bnApprove_Click"></asp:button>
            &nbsp;&nbsp;
            <asp:Button id="bnReturn" runat="server" Text="Return For Editing" onclick="bnReturn_Click"></asp:Button>
            &nbsp;
            <asp:Button id="bnCancel" runat="server" Text="Cancel Story" onclick="bnCancel_Click"></asp:Button>
        </form>
    </body>
</HTML>
