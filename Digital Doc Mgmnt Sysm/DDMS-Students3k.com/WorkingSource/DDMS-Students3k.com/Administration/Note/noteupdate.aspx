<%@ Page language="c#" Inherits="edmsNET.Administration.Note.NoteUpdate" CodeFile="NoteUpdate.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <P>
                ...
                <asp:button id="bnUpdate" runat="server" Text="Update Note" onclick="bnUpdate_Click"></asp:button>
                &nbsp;
