<%@ Page language="c#" Inherits="edmsNET.Administration.Note.NoteList" CodeFile="NoteList.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <P align="right">
                <asp:button id="bnCreate" runat="server" Text="Create A Note" onclick="bnCreate_Click"></asp:button>
            </P>
            <P>
            ...
            <P>
                <asp:Button id="bnReturn" runat="server" Text="Return" onclick="bnReturn_Click"></asp:Button>
            </P>
        </form>
    </body>
</HTML>
