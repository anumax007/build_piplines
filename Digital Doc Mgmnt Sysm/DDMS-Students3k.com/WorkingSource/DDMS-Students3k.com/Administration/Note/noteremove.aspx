<%@ Page language="c#" Inherits="edmsNET.Administration.Note.NoteRemove" CodeFile="NoteRemove.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <P>
                <asp:button id="bnRemove" runat="server" Text="Remove Note" onclick="bnRemove_Click"></asp:button>
