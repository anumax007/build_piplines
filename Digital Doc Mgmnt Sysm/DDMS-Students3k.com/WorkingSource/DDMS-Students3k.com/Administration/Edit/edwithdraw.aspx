<%@ Page language="c#" Inherits="edmsNET.Administration.Edit.EdWithdraw" CodeFile="EdWithdraw.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <P>
                <asp:button id="bnWithdraw" runat="server" Text="Withdraw As Editor" onclick="bnWithdraw_Click"></asp:button>
