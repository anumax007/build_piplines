<%@ Page language="c#" Inherits="edmsNET.Administration.Edit.EdView" CodeFile="EdView.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            <H2>
                <FONT color="darkslategray">Editor&nbsp;: Content View</FONT>
            </H2>
            <P>
            ...
            &nbsp;
            <asp:button id="bnEdit" runat="server" Text="Edit" onclick="bnEdit_Click"></asp:button>
        </form>
    </body>
</HTML>
