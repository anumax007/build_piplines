<%@ Page language="c#" Inherits="edmsNET.Administration.Edit.EdEdit" CodeFile="EdEdit.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <asp:button id="bnInsert" runat="server" Text="Edit to new version" onclick="bnInsert_Click"></asp:button>
            &nbsp;
            <asp:button id="bnUpdate" runat="server" Text="Edit to this version" onclick="bnUpdate_Click"></asp:button>
            &nbsp;
            <asp:button id="bnRestore" runat="server" Text="Restore" onclick="bnRestore_Click"></asp:button>
            &nbsp;
            <asp:button id="bnReturn" runat="server" Text="Return to Author for Fix" onclick="bnReturn_Click"></asp:button>
        </form>
    </body>
</HTML>
