<%@ Page language="c#" Inherits="edmsNET.Administration.Edit.EdReturn" CodeFile="EdReturn.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <P>
                <asp:button id="bnSubmit" runat="server" Text="Return Content" onclick="bnSubmit_Click"></asp:button>
