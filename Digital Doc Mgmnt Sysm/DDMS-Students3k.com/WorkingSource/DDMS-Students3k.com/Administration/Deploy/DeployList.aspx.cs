...
{
	public partial class DeployList : edmsNET.Common.AuthorizedPage
	{
...
//          }
        ...
        protected void bnUpdtRanks_Click(object sender, System.EventArgs e)
        {
            int crow;
            DataTable dtz = zone.GetAllZones();
            DropDownList ddl;
        ...
        protected void ddlZones_SelectedIndexChanged(object sender, System.EventArgs e)
        {
