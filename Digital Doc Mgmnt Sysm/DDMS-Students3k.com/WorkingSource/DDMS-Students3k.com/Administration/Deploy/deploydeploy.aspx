<%@ Page language="c#" Inherits="edmsNET.Administration.Deploy.DeployDeploy" CodeFile="DeployDeploy.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <P>
                <asp:button id="bnDeploy" runat="server" Text="Deploy Content" onclick="bnDeploy_Click"></asp:button>&nbsp;
