<%@ Page language="c#" Inherits="edmsNET.Administration.Deploy.DeployArchive" CodeFile="DeployArchive.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <P>
                <asp:button id="bnArchive" runat="server" Text="Archive Content" onclick="bnArchive_Click"></asp:button>&nbsp;
