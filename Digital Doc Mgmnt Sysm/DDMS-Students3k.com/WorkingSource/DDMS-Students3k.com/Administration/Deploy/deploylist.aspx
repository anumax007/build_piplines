<%@ Page language="c#" Inherits="edmsNET.Administration.Deploy.DeployList" CodeFile="DeployList.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <H3>Site Content for zone :
                <asp:dropdownlist id="ddlZones" runat="server" AutoPostBack="True" onselectedindexchanged="ddlZones_SelectedIndexChanged"></asp:dropdownlist>&nbsp;&nbsp;&nbsp;
                <asp:button id="bnUpdtRanks" runat="server" Text="Update Ranks" onclick="bnUpdtRanks_Click"></asp:button></H3>
