<%@ Page language="c#" Inherits="edmsNET.Administration.Deploy.DeployReturn" CodeFile="DeployReturn.aspx.cs" CodeFileBaseClass="edmsNET.Common.AuthorizedPage" %>
...
<HTML>
    ...
    <body>
        <form method="post" runat="server">
            ...
            <P>
                <asp:button id="bnReturn" runat="server" Text="Return Content" onclick="bnReturn_Click"></asp:button>&nbsp;
